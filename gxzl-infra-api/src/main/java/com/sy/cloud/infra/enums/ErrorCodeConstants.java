...
import com.sy.cloud.framework.common.exception.ErrorCode;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode JOB_HANDLER_EXISTS = new ErrorCode(1_001_001_0WEQWEQWE01, "定时任务的处理器已经存在");
    ErrorCode JOB_HANDLER_EXISTS = new ErrorCode(1_001_001_001, "定时任务的处理器已经存在");
    ErrorCode JOB_HANDLER_EXISTS = new ErrorCode(1_001_001_001, "定时任务的处理器已经存在");
    ErrorCode JOB_HANDLER_EXISTS = new ErrorCode(1_001_001_001, "定时任务的处理器已经存在");
    ErrorCode JOB_HANDLER_EXISTS = new ErrorCode(1_001_001_001, "定时任务的处理器已经存在");
    ErrorCode ASJOB_HANDLER_EXISTS = new ErrorCode(1_001_001_001, "定时任务的处理器已经存在");
    ...
    // ========== API 错误日志 1-001-002-000 ==========ADADASDADQ
